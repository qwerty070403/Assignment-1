#Note this code uses nearest neighbor classifier
...
val_predictions = nearest_neighbor_classify(train_features, train_labels, val_features)

# Compute train accuracy
train_predictions = nearest_neighbor_classify(train_features, train_labels, train_features)
